...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value1 != null) {
			...
			Bulbasaur obj = new Bulbasaur("Bulbasaur", 001,
					"Bulbasaur is a Grass/Poison-type Pokémon introduced in Generation I.It evolves into Ivysaur starting at level 16. It is one of the three Starter Pokémon in the Kanto region.",
					"POISON", "IVYSAUR", "64");
			msg = "<center>" + obj.getPokemonName() + "  #" + obj.getPokemonNumber();
			request.setAttribute("message1", obj.getPokemonNumber());
			request.setAttribute("character1", obj.getCharacteristics());
			request.setAttribute("type1", obj.getType());
			request.setAttribute("evolution1", obj.getEvolution());
			request.setAttribute("baseExp1", obj.getBaseExp());
		}

		if (value2 != null) {
			// Create the object for Charizard class and use getters to retrieve the values
			Charizard obj = new Charizard("Charizard", 006,
					...
					"FIRE", "CHARMELEON", "240");
			msg = "<center>" + obj.getPokemonName() + "  #" + obj.getPokemonNumber();
			request.setAttribute("message2", obj.getPokemonNumber());
			request.setAttribute("character2", obj.getCharacteristics());
			request.setAttribute("type2", obj.getType());
			request.setAttribute("evolution2", obj.getEvolution());
			request.setAttribute("baseExp2", obj.getBaseExp());
		}
		...
		if (value4 != null) {
			...
			Mew m = new Mew("Mew", 151,
					"Mew is a Psychic-type Mythical Pokémon introduced in Generation I. Mew is notable for its unique ability to learn every Technical Machine, Technical Record & Hidden Machine.",
					"PSYCHIC", "NONE", "64");
		...
		if (value5 != null) {
			...
			Pikachu p = new Pikachu("Pikachu", 25,
					"Pikachu is an Electric-type Pokémon, which was introduced in Generation I. Over the years, Pikachu has become so popular that it serves as the Pokémon franchise mascot.",
					"ELECTRIC", "RAICHU", "112");
